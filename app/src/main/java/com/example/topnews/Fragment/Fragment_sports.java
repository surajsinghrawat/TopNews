...
public class Fragment_sports extends Fragment {
    ...
    private static final String URL = "https://newsapi.org/v2/top-headlines?country=us&category=Sports&apiKey=72daddecba9840dd8e1ab24b7e88df6f";


    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout =  inflater.inflate(R.layout.fragment_sports, container, false);

        recyclerView = layout.findViewById(R.id.itemList);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        RequestClass request=new RequestClass(Request.Method.GET, RequestClass.SPORT,
